...
AppShift::MemoryPool::MemoryPool(size_t block_size)
{
...
AppShift::MemoryPool::~MemoryPool() {
...
void AppShift::MemoryPool::createMemoryBlock(size_t block_size)
{
	// Create the block
...
void* AppShift::MemoryPool::allocate(size_t size)
{
...
void* AppShift::MemoryPool::reallocate(void* unit_pointer_start, size_t new_size)
{
...
void AppShift::MemoryPool::free(void* unit_pointer_start)
{
...
void AppShift::MemoryPool::dumpPoolData()
{
...
void AppShift::MemoryPool::startScope()
{
...
void AppShift::MemoryPool::endScope()
{
...
void* operator new(size_t size, AppShift::MemoryPool* mp) {
